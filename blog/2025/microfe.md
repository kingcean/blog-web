...
We usually write some functional components that return a Virtual DOM tree using JSX/TSX syntax through `return`. The structure of this tree is typically generated by a series of code logic, and without considering passing the source code between processes, it seems unlikely to convert it into a string.
